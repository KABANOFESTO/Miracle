      ...
      <div className="contact-section container">
        <div className="contact-info">
          ...
          <div className="contact-content">
            ...
            <div>
              <p>
                Email: <span className="bold">miracleCenter@gmail.com </span>
              </p>
            </div>
            <div>
              <p>
                Website: <span className="bold"><a href="https://miracle-two.vercel.app/" target="_blank" rel="noopener noreferrer">Miracle-Center web</a></span>
              </p>
            </div>
          </div>
        </div>
